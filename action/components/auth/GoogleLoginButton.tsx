...
export const GoogleSignInButton: React.FC<GoogleSignInButtonProps> = ({ children, ...props }) => {
    return (
        <button
            {...props}
            className={twMerge([
                "border-neutral-gray-200 text-neutral-black flex h-[56px] w-full cursor-pointer items-center justify-center rounded-full border text-[16px] font-semibold transition",
        ...
        >
            <div className="mr-[12px] h-[24px] w-[24px]">
