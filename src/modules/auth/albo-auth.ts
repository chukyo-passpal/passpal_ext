...
export class AlboAuthManager {
    ...
    static detectLogoutMessage(): boolean {
        const messageElement: QueryResult<HTMLElement> = document.querySelector(SELECTORS.ALBO.LOGOUT_MESSAGE);
    ...
    static detectServerError(): boolean {
        const errorElement: QueryResult<HTMLHeadingElement> = document.querySelector(SELECTORS.ALBO.ERROR_TITLE);
